...
- **Transaction**:
  ...
  ##  IV. CONCLUSION
   ...
   In this project, we successfully designed and implemented a comprehensive subway management system that meets both basic and advanced requirements. Utilizing MySQL and Spring Boot, we integrated functionalities such as station and line management, ride recording, and passenger information handling. Our system also includes advanced features like business carriage management, integration with buses and landmarks, and robust search capabilities. The project's efficient handling of large datasets, interactive UI/UX design, and adherence to database best practices highlight our ability to work collaboratively and deliver a functional, user-friendly webpage.