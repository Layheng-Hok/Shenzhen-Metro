...
(
    bus_info_id BIGSERIAL PRIMARY KEY,
    bus_line    VARCHAR(50) NOT NULL,
    bus_name    VARCHAR(50) NOT NULL,
    UNIQUE (bus_line, bus_name)
);

CREATE TABLE IF NOT EXISTS bus_exit_info
(
    bus_exit_info_id BIGSERIAL PRIMARY KEY,
    ...
    UNIQUE (station_name, exit_gate, bus_info_id)
);
